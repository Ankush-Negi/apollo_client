...
class AddDialog extends React.Component {
  ...
  handleSubmit = async (openSnackBar) => {
    ...
    const data = await onSubmit({email, password, name, address, dob, role});
    if(data.error) openSnackBar('Error', 'danger');
    if(data.response) openSnackBar('Added Successfully', 'success');
    this.toggler();
    onClose();
  }
